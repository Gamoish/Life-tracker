 ...
 * days it's due. Read-only decoration; `DayPicker` below is the real control.
 */
 ...
 * weekday values 1–7) so `formData.getAll("scheduledDays")` reads them
 * straight off the form — no client-side serialization needed.
 */
